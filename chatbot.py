...
# Creating two dictionary that map the questions words a nthe answers words to a unique integer
threshold = 20
questionswords2int = {}
word_number = 0
...
def decode_training_set(encoder_state,decoder_cell,decoder_embedded_input,sequence_length,decoding_scope,output_function,keep_prob,batch_size):
    ...
    attention_keys,attention_values,attention_score_function,attention_construct_function = tf.contrib.seq2seq.prepare_attention(attention_states,atteion_option = 'bahdanau',num_units = decoder_cell.output_size)
